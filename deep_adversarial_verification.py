...
resp_js = urllib.request.urlopen(f"https://{SERVER_IP}:{PORT}/portal/qrcode.min.js", timeout=12)
...
resp_sub = urllib.request.urlopen(f"https://{SERVER_IP}:{PORT}/sub/{TOKEN}", timeout=12)
...
resp_b64 = urllib.request.urlopen(f"https://{SERVER_IP}:{PORT}/sub/{TOKEN}/b64", timeout=12)
...
resp_links = urllib.request.urlopen(f"https://{SERVER_IP}:{PORT}/sub/{TOKEN}/links", timeout=12)
...
resp_totp_path = urllib.request.urlopen(f"https://{SERVER_IP}:{PORT}/sub/{curr_totp}", timeout=15)
...
resp_totp_b64 = urllib.request.urlopen(f"https://{SERVER_IP}:{PORT}/sub/{fresh_totp_b64}/b64", timeout=15)
...
resp_totp_query = urllib.request.urlopen(f"https://{SERVER_IP}:{PORT}/sub/totp?code={fresh_totp_query}", timeout=15)
